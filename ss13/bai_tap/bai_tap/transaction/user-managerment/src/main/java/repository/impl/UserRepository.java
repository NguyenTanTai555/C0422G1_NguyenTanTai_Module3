...
public class UserRepository implements IUserRepository {
    ...
    private static final String QUERY_INSERT_USER_SP = "CALL insert_user()";
    private static final String QUERY_INSERT_USERS_DETAIL = "call add_user_detail(?,?,?);";
    ...
    public void addUserTransaction() {
        ...
        try {
            ...
            callableStatement = connection.prepareCall(QUERY_INSERT_USER_SP);
            callableStatement.setString(1,"Cường");
            callableStatement.setString(2,"cuong@@gmailcom");
            callableStatement.setString(3,"Đà Nẵng");
            int affectRow =  callableStatement.executeUpdate();

            callableStatement = connection.prepareCall(QUERY_INSERT_USERS_DETAIL);
            callableStatement.setString(1,"Đà Nẵng");
